...
var (
	_ resource.Resource                = &AWSIDCGroupSelectorResource{}
	_ resource.ResourceWithConfigure   = &AWSIDCGroupSelectorResource{}
	_ resource.ResourceWithImportState = &AWSIDCGroupSelectorResource{}
)
...
func (r *AWSIDCGroupSelectorResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_aws_idc_group_selector"
}
...
func (r *AWSIDCGroupSelectorResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	...
	resp.Schema = schema.Schema{
		Description: "A Selector to match AWS IAM Identity Center group with a criteria based on the 'when' field.",
		Attributes: map[string]schema.Attribute{
			...
			"when": schema.StringAttribute{
				MarkdownDescription: "A Cedar expression with the criteria to match accounts on, e.g: `resource.name == \"production-access\"`",
				Required:            true,
			},
		},
		MarkdownDescription: `A Selector to match AWS IAM Identity Center groups with a criteria based on the 'when' field.`,
	}
}
