...
func (s AWSEKSSelector) ToAPI() *configv1alpha1.Selector {
...
var (
	_ resource.Resource                = &AWSEKSSelectorResource{}
	_ resource.ResourceWithConfigure   = &AWSEKSSelectorResource{}
...
func (r *AWSEKSSelectorResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	...
	resp.Schema = schema.Schema{
		Description: "A Selector to match AWS EKS Cluster with a criteria based on the 'when' field.",
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "The unique name of the selector. Call this something memorable and relevant to the resources being selected. For example: `prod-eks`",
				Optional:            true,
			},
			...
			"when": schema.StringAttribute{
				MarkdownDescription: "A Cedar expression with the criteria to match aws EKS on, e.g: `resource in AWS::Account::\"12345678912\"`",
				Required:            true,
			},
		},
		MarkdownDescription: `A Selector to match AWS EKS with a criteria based on the 'when' field.`,
	}
}

func (r *AWSEKSSelectorResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *AWSEKSSelectorResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	if r.client == nil {
		resp.Diagnostics.AddError(
			"Unconfigured HTTP Client",
			"Expected configured HTTP client. Please report this issue to the provider developers.",
...
func (r *AWSEKSSelectorResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	if r.client == nil {
		resp.Diagnostics.AddError(
			"Unconfigured HTTP Client",
			"Expected configured HTTP client. Please report this issue to the provider developers.",
...
func (r *AWSEKSSelectorResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	if r.client == nil {
		resp.Diagnostics.AddError(
			"Unconfigured HTTP Client",
			"Expected configured HTTP client. Please report this issue to the provider developers.",
...
func (r *AWSEKSSelectorResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
